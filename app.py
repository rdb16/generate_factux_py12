...
def validate_emitter_config(config: dict) -> list[str]:
    ...
    # Validation identifiant Peppol émetteur (9 à 32 caractères : chiffres ou _)
    ...
    elif not re.match(r'^[\d_]{9,32}$', recipient_pepol):
        errors.append(f"Identifiant Peppol invalide: '{recipient_pepol}' (doit contenir 9 à 32 caractères : chiffres ou _)")
